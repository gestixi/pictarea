/*! Pictarea v1.0 | ©2016 GestiXi | Licensed under the MIT license */
...
d=c.areaDisableKey,e=c.normal;d&&a.hasAttribute(d)?e=c.disabled:(a===this.hovered&&(e=f.extend({},e,c.hover)),this.selection&&-1<this.selection.indexOf(a)&&(e=f.extend({},e,c.active)));f.extend(b,e);b.fill();b.stroke()},mouseover:function(a){var b=a.target,c=this.options.areaDisableKey;!b||c&&b.hasAttribute(c)||(a=f.Event("enterArea.pictarea",{originalEvent:a,area:b,pictarea:this}),this.$img.trigger(a),a.isDefaultPrevented()||(this.hovered=b,this.drawCanvas()))},mouseout:function(a){var b=a.target;
b&&(a=f.Event("leaveArea.pictarea",{originalEvent:a,area:b,pictarea:this}),this.$img.trigger(a),a.isDefaultPrevented()||(this.hovered=null,this.drawCanvas()))},select:function(a){var b=a.target,c=this.options,d=c.areaValueKey,e=this.selection,g=null,h=f.Event("selectArea.pictarea",{originalEvent:a,area:b,key:d?b.getAttribute(d):null,pictarea:this});this.$img.trigger(h);if(!h.isDefaultPrevented()){e||(e=[]);var h=e.indexOf(b),k=c.maxSelections;for(-1===h?e.push(b):e.splice(h,1);0<=k&&e.length>c.maxSelections;)e.shift();
d&&(1===k?e[0]&&(g=e[0].getAttribute(d)):1<k&&(g=[],e.forEach(function(a){(a=a.getAttribute(d))&&g.push(a)})));this.selection=e;this.value=g;this.drawCanvas();a=f.Event("change.pictarea",{originalEvent:a,area:b,selection:e,value:g,pictarea:this});this.$img.trigger(a)}},destroy:function(){this._isDestroyed=!0;this.$img.removeData("pictarea")},scheduleRedraw:function(){if(!this._didScheduleScale)if(window.requestAnimationFrame){var a=this;this._didScheduleScale=!0;requestAnimationFrame(function(){a.drawCanvas()})}else this.drawCanvas()}}}(window.jQuery);